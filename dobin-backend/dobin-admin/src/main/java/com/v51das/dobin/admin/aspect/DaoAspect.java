package com.v51das.dobin.admin.aspect;
...
import com.v51das.dobin.common.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* com.v51das.dobin.*.dao.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* com.v51das.dobin.*.dao.*.insert*(..))")
